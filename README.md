...
<h3 align="center">🎓 M.S. in Electrical & Computer Engineering @ Boston University | 💻 AI Engineer & Software Engineer</h3>
...
🔹 [**AI-Powered Customer Support Platform**](https://github.com/KENNETH1005-zy) — Generative AI assistant for Shopify merchants built with **Python**, **FastAPI**, **LangChain**, and a **RAG** pipeline over **Pinecone**, with a **RAGAS** evaluation framework and **React/TypeScript** frontend.

🔹 [**Medical Care Plan Generation System**](https://github.com/KENNETH1005-zy/Medical_Care_Plan_Generation_System) — LLM-powered backend that generates personalized medication plans and checks interactions, built with **Java**, **Spring Boot**, **PostgreSQL**, and **Redis**.
...
⚡ Currently building AI-powered applications with RAG, LLMs, and agents
